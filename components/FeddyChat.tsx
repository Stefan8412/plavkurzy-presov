...
const questions: Question[] = [
  ...
  },
  {
    ...
    answer:
      "Za kurz môžete zaplatiť online cez platobnú bránu Comgate. Prihláste sa do svojho účtu na našej stránke, otvorte sekciu Moje kurzy a pri príslušnom kurze kliknite na tlačidlo „Zaplatiť cez Comgate“. Následne budete presmerovaní na bezpečnú platobnú bránu Comgate, kde platbu dokončíte. Po úspešnej platbe bude platba automaticky priradená k vašej registrácii.",
    keywords: [
      "platba",
      "platiť",
      "platit",
